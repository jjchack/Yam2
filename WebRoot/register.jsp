...
<div class="form-bak">
	<form method="post" action="register" onsubmit="adaptValue();">
		<div class="left">
			<div class="line" id="line_account">
				<div class="info">
					<strong>手机号</strong>
					<span class="tips">正确填写哦</span>
					
				</div>
				
				<div class="input">
					<input type="text" name="phone" id="account" onblur="v_account();" onkeyup="v_account();"/>
			...
			<div class="line" id="line_name">
				<div class="info">
					<strong>用户名</strong>
					<span class="tips" id="usererror">只能由数字、文字或下划线组成<br/>最多8个字符</span>
				</div>
				<div class="input" >
		...
		<div class="right">
			...
			<div>已经拥有账号，<a href="/Yam/login.jsp">直接登录</a></div>
...
function v_account(){
	...
	if(!RegEmail.test(account)) {lineState("account","error","手机号格式不正确"); flags[0]=false;enableSubmit(false);}
