	...
	$(function(){
		$(":input[name='fbsubmit']").click(function(){
			...
			var price = $.trim($(".price").val());
				if(goodsname != ""&&desc!=""&&price!="") {
					var url = "${pageContext.request.contextPath}/GoodsUpLoad";
					var args = {"fb":"ok","goodsname":goodsname,"property1":property1,"desc":desc,"price":price,"time":new Date()};
  		...
  		<div class="webIndex">
					<div class="stay-list clearFloat">
						<div class="stay-list-left">
							...
							<div class="tupian">
								<div class="tupiantitle">上传图片（上传图片建议大小 250*218像素）</div>
								<div class="liulan">
									<tr>
							...
							<form id="form1" name="form1" method="post" action="">
								...
								<div class="sea-div">
									<label class="search-lab">商品名称</label><input type="text"
										placeholder="物品名称" class="hotel-name" id="disHotel" />
								</div>
								<div class="sea-div">
									<label class="search-lab">商品详述</label><br>
									<textarea rows="5" cols="50" class="texta" name="desc"></textarea>
								</div>
								<div class="sea-div">
									<label class="search-lab">价格</label>
									<input type="text" class="price" name="price" />
								</div>
								<div class="sea-div">
									<label class="search-lab">物品类别</label> 
									<select name="property1" id="property1"size="1" onChange="redirect(this.options.selectedIndex)"
										class="property1">
										<option value="铁棍山药">铁棍山药</option>
										<option value="五谷杂粮">五谷杂粮</option>
										<option value="干果干货">干果干货</option>
										<option value="零食小吃">零食小吃</option>
								</div>
