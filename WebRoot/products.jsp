...
<body>
  <!--header-->
	<div class="header">
		...
		<div class="container">
			<div class="products">
					<h2 class=" products-in">${requestname }</h2>
						<div class=" top-products">
							<c:forEach items="${sessionScope.diffimgurllist }" var="list" varStatus="aa" >
								<div class="col-md-3 md-col">
								<div class="col-md">
									<a href="GetSingleById?goodsid=${list.id }" class="compare-in"><img  src="${list.imgurl } " alt="" style="width: 236px; height: 205px;" />
									<div class="compare">
										<span>查看详情</span>
									</div>
									</a>	
